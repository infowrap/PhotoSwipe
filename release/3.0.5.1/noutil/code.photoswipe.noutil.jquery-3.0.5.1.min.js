...
(function(d,j,a){a.registerNamespace("Code.PhotoSwipe.Image");var b=d.Code.PhotoSwipe;b.Image.ImageClass=j({refObj:null,imageEl:null,src:null,caption:null,metaData:null,imageLoadHandler:null,imageErrorHandler:null,dispose:function(){var c;this.shrinkImage();a.isNothing(this.imageEl)||(this.imageEl.onload=null);for(c in this)a.objectHasProperty(this,c)&&(this[c]=null)},initialize:function(a,f,b,i){this.refObj=a;this.src=this.originalSrc=f;this.caption=b;this.metaData=i;this.imageEl=new d.Image;this.imageLoadHandler=
...
(function(d,j,a){a.registerNamespace("Code.PhotoSwipe.Cache");d=d.Code.PhotoSwipe;d.Cache.Mode={normal:"normal",aggressive:"aggressive"};d.Cache.Functions={getImageSource:function(a){return a.href},getImageCaption:function(b){if("IMG"===b.nodeName)return a.DOM.getAttribute(b,"alt");if("DIV"===b.nodeName)return a.DOM.getData(b,"toolbar-caption");var c,f,e;c=0;for(f=b.childNodes.length;c<f;c++){e=b.childNodes[c];if("IMG"===b.childNodes[c].nodeName)return a.DOM.getAttribute(e,"alt");if("DIV"===b.childNodes[c].nodeName)return a.DOM.getData(b,
"toolbar-caption")}},getImageMetaData:function(){return{}}}})(window,window.klass,window.Code.Util);
...
position:"absolute",left:0,top:0,zIndex:this.settings.zIndex});a.DOM.hide(this.el);this.settings.target===d?a.DOM.appendToBody(this.el):a.DOM.appendChild(this.el,this.settings.target);a.Animation.resetTranslate(this.el);this.initialBodyHeight=a.DOM.bodyOuterHeight()},resetPosition:function(){var c,f,b;this.settings.target===d?(c=a.DOM.windowWidth(),f=2*a.DOM.bodyOuterHeight(),b=this.settings.jQueryMobile?a.DOM.windowScrollTop()+"px":"0px",1>f&&(f=this.initialBodyHeight),a.DOM.windowHeight()>f&&(f=
a.DOM.windowHeight())):(c=a.DOM.width(this.settings.target),f=a.DOM.height(this.settings.target),b="0px");a.DOM.setStyle(this.el,{width:c,height:f,top:b})},fadeIn:function(c,f){this.resetPosition();a.DOM.setStyle(this.el,"opacity",0);a.DOM.show(this.el);a.Animation.fadeIn(this.el,c,f)}})})(window,window.klass,window.Code.Util);
...
this.el);i=3>c.images.length?c.images.length:3;for(e=0;e<i;e++)h=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.item+" "+b.Carousel.CssClasses.item+"-"+e},""),a.DOM.setAttribute(h,"style","float: left;"),a.DOM.setStyle(h,{display:"block",position:"relative",left:0,top:0,overflow:"hidden"}),0<this.settings.margin&&a.DOM.setStyle(h,{marginRight:this.settings.margin+"px"}),a.DOM.appendChild(h,this.contentEl);this.settings.target===d?a.DOM.appendToBody(this.el):a.DOM.appendChild(this.el,this.settings.target)},
resetPosition:function(){var c,f,e,i,h,g;this.settings.target===d?(c=a.DOM.windowWidth(),f=a.DOM.windowHeight(),e=a.DOM.windowScrollTop()+"px"):(c=a.DOM.width(this.settings.target),f=a.DOM.height(this.settings.target),e="0px");i=0<this.settings.margin?c+this.settings.margin:c;h=a.DOM.find("."+b.Carousel.CssClasses.item,this.contentEl);i*=h.length;a.DOM.setStyle(this.el,{top:e,width:c,height:f});a.DOM.setStyle(this.contentEl,{width:i,height:f});e=0;for(i=h.length;e<i;e++)g=h[e],a.DOM.setStyle(g,{width:c,
height:f}),g=a.DOM.find("img",g)[0],a.isNothing(g)||this.resetImagePosition(g);this.setContentLeftPosition()},resetImagePosition:function(c){if(!a.isNothing(c)){a.DOM.getAttribute(c,"src");var f,b,d,h;h=a.DOM.width(this.el);var g=a.DOM.height(this.el);if("fitNoUpscale"===this.settings.imageScaleMethod){if(b=c.naturalWidth,d=c.naturalHeight,b>h&&(f=h/b,b=Math.round(b*f),d=Math.round(d*f)),d>g)f=g/d,d=Math.round(d*f),b=Math.round(b*f)}else f=c.isLandscape?h/c.naturalWidth:g/c.naturalHeight,b=Math.round(c.naturalWidth*
f),d=Math.round(c.naturalHeight*f),"zoom"===this.settings.imageScaleMethod?(f=1,d<g?f=g/d:b<h&&(f=h/b),1!==f&&(b=Math.round(b*f),d=Math.round(d*f))):"fit"===this.settings.imageScaleMethod&&(f=1,b>h?f=h/b:d>g&&(f=g/d),1!==f&&(b=Math.round(b*f),d=Math.round(d*f)));f=Math.round((g-d)/2)+"px";h=Math.round((h-b)/2)+"px";a.DOM.setStyle(c,{position:"absolute",width:b,height:d,top:f,left:h,display:"block"})}},setContentLeftPosition:function(){var c,b,e;c=this.settings.target===d?a.DOM.windowWidth():a.DOM.width(this.settings.target);
b=this.getItemEls();e=0;this.settings.loop?e=-1*(c+this.settings.margin):this.currentCacheIndex===this.cache.images.length-1?e=-1*(b.length-1)*(c+this.settings.margin):0<this.currentCacheIndex&&(e=-1*(c+this.settings.margin));a.DOM.setStyle(this.contentEl,{left:e+"px"})},show:function(c){this.currentCacheIndex=c;this.resetPosition();this.setImages(!1);a.DOM.show(this.el);a.Animation.resetTranslate(this.contentEl);var c=this.getItemEls(),f,d;f=0;for(d=c.length;f<d;f++)a.Animation.resetTranslate(c[f]);
a.Events.fire(this,{type:b.Carousel.EventTypes.onSlideByEnd,target:this,action:b.Carousel.SlideByAction.current,cacheIndex:this.currentCacheIndex})},setImages:function(a){var b,d=this.getItemEls();b=this.currentCacheIndex+1;var i=this.currentCacheIndex-1;this.settings.loop?(b>this.cache.images.length-1&&(b=0),0>i&&(i=this.cache.images.length-1),b=this.cache.getImages([i,this.currentCacheIndex,b]),a||this.addCacheImageToItemEl(b[1],d[1]),this.addCacheImageToItemEl(b[2],d[2]),this.addCacheImageToItemEl(b[0],
...
this.imageErrorHandler);c.load()},slideCarousel:function(c,f,e){if(!this.isSliding){var i,h;i=this.settings.target===d?a.DOM.windowWidth()+this.settings.margin:a.DOM.width(this.settings.target)+this.settings.margin;e=a.coalesce(e,this.settings.slideSpeed);if(!(1>d.Math.abs(h))){switch(f){case a.TouchElement.ActionTypes.swipeLeft:c=-1*i;break;case a.TouchElement.ActionTypes.swipeRight:c=i;break;default:h=c.x-this.touchStartPoint.x,c=d.Math.abs(h)>i/2?0<h?i:-1*i:0}this.lastSlideByAction=0>c?b.Carousel.SlideByAction.next:
...
this.isSlideshowActive=!0;this.slideshowTimeout=d.setTimeout(this.slideshowNext.bind(this),this.settings.slideshowDelay);a.Events.fire(this,{type:b.Carousel.EventTypes.onSlideshowStart,target:this})},stopSlideshow:function(){a.isNothing(this.slideshowTimeout)||(d.clearTimeout(this.slideshowTimeout),this.slideshowTimeout=null,this.isSlideshowActive=!1,a.Events.fire(this,{type:b.Carousel.EventTypes.onSlideshowStop,target:this}))},onSlideByEnd:function(){if(!a.isNothing(this.isSliding)){var c=this.getItemEls();
...
"",c[a.Animation._transitionPrefix+"TimingFunction"]="",c[a.Animation._transitionPrefix+"Delay"]="0",c[a.Animation._transformLabel]=a.Browser.is3dSupported?"translate3d("+b+"px, 0px, 0px)":"translate("+b+"px, 0px)",a.DOM.setStyle(this.contentEl,c)):a.isNothing(d.jQuery)||d.jQuery(this.contentEl).stop().css("left",this.getStartingPos().x+b+"px")},doSlideCarousel:function(b,c){var f;0>=c?this.slideByEndHandler():a.Browser.isCSSTransformSupported?(f=a.coalesce(this.contentEl.style.webkitTransform,this.contentEl.style.MozTransform,
this.contentEl.style.OTransform,this.contentEl.style.transform,""),0===f.indexOf("translate3d("+b)?this.slideByEndHandler():0===f.indexOf("translate("+b)?this.slideByEndHandler():a.Animation.slideBy(this.contentEl,b,0,c,this.slideByEndHandler,this.settings.slideTimingFunction)):a.isNothing(d.jQuery)||(f={left:this.getStartingPos().x+b+"px"},"ease-out"===this.settings.animationTimingFunction&&(this.settings.animationTimingFunction="easeOutQuad"),a.isNothing(d.jQuery.easing[this.settings.animationTimingFunction])&&
(this.settings.animationTimingFunction="linear"),d.jQuery(this.contentEl).animate(f,this.settings.slideSpeed,this.settings.animationTimingFunction,this.slideByEndHandler))}})})(window,window.klass,window.Code.Util,window.Code.PhotoSwipe.TouchElement);
...
b.Toolbar.CssClasses.playDisabled)),0===c&&(a.isNothing(this.previousEl)||a.DOM.addClass(this.previousEl,b.Toolbar.CssClasses.previousDisabled)),c===this.cache.images.length-1&&(a.isNothing(this.nextEl)||a.DOM.addClass(this.nextEl,b.Toolbar.CssClasses.nextDisabled))))},onFadeOut:function(){a.DOM.hide(this.toolbarEl);a.DOM.hide(this.captionEl);a.Events.fire(this,{type:b.Toolbar.EventTypes.onHide,target:this})},onTouchStart:function(c){c.preventDefault();a.Events.remove(this.toolbarEl,"click",this.clickHandler);
this.handleTap(c)},onTouchMove:function(a){a.preventDefault()},onClick:function(a){a.preventDefault();this.handleTap(a)}})})(window,window.klass,window.Code.Util);(function(d,j,a){a.registerNamespace("Code.PhotoSwipe.UILayer");d.Code.PhotoSwipe.UILayer.CssClasses={uiLayer:"ps-uilayer"}})(window,window.klass,window.Code.Util);
...
a.instances=[];a.activeInstances=[];a.setActivateInstance=function(b){if(-1<j.arrayIndexOf(b.settings.target,a.activeInstances,"target"))throw"Code.PhotoSwipe.activateInstance: Unable to active instance as another instance is already active for this target";a.activeInstances.push({target:b.settings.target,instance:b})};a.unsetActivateInstance=function(b){b=j.arrayIndexOf(b,a.activeInstances,"instance");a.activeInstances.splice(b,1)};a.attach=function(b,c,d){var e,i;e=a.createInstance(b,c,d);c=0;for(d=
b.length;c<d;c++)i=b[c],!j.isNothing(i.nodeType)&&1===i.nodeType&&(i.__photoSwipeClickHandler=a.onTriggerElementClick.bind(e),j.Events.remove(i,"click",i.__photoSwipeClickHandler),j.Events.add(i,"click",i.__photoSwipeClickHandler));return e};d.jQuery&&(d.jQuery.fn.photoSwipe=function(b,c){return a.attach(this,b,c)});a.detatch=function(b){var c,d,e;c=0;for(d=b.originalImages.length;c<d;c++){e=b.originalImages[c];if(!j.isNothing(e.nodeType)&&e.nodeType===1){j.Events.remove(e,"click",e.__photoSwipeClickHandler);
...
a.Events.remove(this,g.EventTypes.onCaptionAndToolbarHide);a.Events.remove(this,g.EventTypes.onZoomPanRotateTransform);this.removeEventHandlers();a.isNothing(this.documentOverlay)||this.documentOverlay.dispose();a.isNothing(this.carousel)||this.carousel.dispose();this.destroyZoomPanRotate();a.isNothing(this.uiLayer)||this.uiLayer.dispose();a.isNothing(this.toolbar)||this.toolbar.dispose();a.isNothing(this.cache)||this.cache.dispose();for(b in this)a.objectHasProperty(this,b)&&(this[b]=null)},initialize:function(c,
e,f){this.id=a.isNothing(f)?"PhotoSwipe"+(new Date).getTime().toString():f;this.originalImages=c;a.Browser.android&&!a.Browser.firefox&&2.1<=d.navigator.userAgent.match(/Android (\d+.\d+)/).toString().replace(/^.*\,/,"")&&(this.isBackEventSupported=!0);this.isBackEventSupported||(this.isBackEventSupported=a.objectHasProperty(d,"onhashchange"));this.settings={fadeInSpeed:250,fadeOutSpeed:250,preventHide:!1,preventSlideshow:!1,zIndex:1E3,backButtonHideEnabled:!0,enableKeyboard:!0,enableMouseWheel:!0,
mouseWheelSpeed:350,autoStartSlideshow:!1,jQueryMobile:!a.isNothing(d.jQuery)&&!a.isNothing(d.jQuery.mobile),jQueryMobileDialogHash:"&ui-state=dialog",enableUIWebViewRepositionTimeout:!1,uiWebViewResetPositionDelay:500,target:d,preventDefaultTouchEvents:!0,allowVerticalScroll:!1,loop:!0,slideSpeed:250,nextPreviousSlideSpeed:0,enableDrag:!0,swipeThreshold:50,swipeTimeThreshold:250,slideTimingFunction:"ease-out",slideshowDelay:3E3,doubleTapSpeed:250,margin:20,imageScaleMethod:"fit",captionAndToolbarHide:!1,
...
a.Browser.android?this.orientationEventName="resize":a.Browser.iOS&&!a.Browser.safari?a.Events.add(d.document.body,"orientationchange",this.windowOrientationChangeHandler):this.orientationEventName=!a.isNothing(d.onorientationchange)?"orientationchange":"resize";a.isNothing(this.orientationEventName)||a.Events.add(d,this.orientationEventName,this.windowOrientationChangeHandler);this.settings.target===d&&a.Events.add(d,"scroll",this.windowScrollHandler);this.settings.enableKeyboard&&a.Events.add(d.document,
"keydown",this.keyDownHandler);this.isBackEventSupported&&this.settings.backButtonHideEnabled&&(this.windowHashChangeHandler=this.onWindowHashChange.bind(this),this.settings.jQueryMobile?d.location.hash=this.settings.jQueryMobileDialogHash:(this.currentHistoryHashValue="PhotoSwipe"+(new Date).getTime().toString(),d.location.hash=this.currentHistoryHashValue),a.Events.add(d,"hashchange",this.windowHashChangeHandler));this.settings.enableMouseWheel&&a.Events.add(d,"mousewheel",this.mouseWheelHandler);
a.Events.add(this.uiLayer,a.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);a.Events.add(this.carousel,f.EventTypes.onSlideByEnd,this.carouselSlideByEndHandler);a.Events.add(this.carousel,f.EventTypes.onSlideshowStart,this.carouselSlideshowStartHandler);a.Events.add(this.carousel,f.EventTypes.onSlideshowStop,this.carouselSlideshowStopHandler);a.isNothing(this.toolbar)||(a.Events.add(this.toolbar,e.EventTypes.onTap,this.toolbarTapHandler),a.Events.add(this.toolbar,e.EventTypes.onBeforeShow,
this.toolbarBeforeShowHandler),a.Events.add(this.toolbar,e.EventTypes.onShow,this.toolbarShowHandler),a.Events.add(this.toolbar,e.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.add(this.toolbar,e.EventTypes.onHide,this.toolbarHideHandler))},removeEventHandlers:function(){a.Browser.iOS&&!a.Browser.safari&&a.Events.remove(d.document.body,"orientationchange",this.windowOrientationChangeHandler);a.isNothing(this.orientationEventName)||a.Events.remove(d,this.orientationEventName,this.windowOrientationChangeHandler);
a.Events.remove(d,"scroll",this.windowScrollHandler);this.settings.enableKeyboard&&a.Events.remove(d.document,"keydown",this.keyDownHandler);this.isBackEventSupported&&(this.settings.backButtonHideEnabled&&null!==this.windowHashChangeHandler)&&a.Events.remove(d,"hashchange",this.windowHashChangeHandler);this.settings.enableMouseWheel&&a.Events.remove(d,"mousewheel",this.mouseWheelHandler);a.isNothing(this.uiLayer)||a.Events.remove(this.uiLayer,a.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);
...
e.EventTypes.onShow,this.toolbarShowHandler),a.Events.remove(this.toolbar,e.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.remove(this.toolbar,e.EventTypes.onHide,this.toolbarHideHandler))},hide:function(){if(!this.settings.preventHide){if(a.isNothing(this.documentOverlay))throw"Code.PhotoSwipe.PhotoSwipeClass.hide: PhotoSwipe instance is already hidden";a.isNothing(this.hiding)&&(this.clearUIWebViewResetPositionTimeout(),this.destroyZoomPanRotate(),this.removeEventHandlers(),a.Events.fire(this,
{type:g.EventTypes.onBeforeHide,target:this}),this.uiLayer.dispose(),this.uiLayer=null,a.isNothing(this.toolbar)||(this.toolbar.dispose(),this.toolbar=null),this.carousel.dispose(),this.carousel=null,a.DOM.removeClass(d.document.body,g.CssClasses.activeBody),a.DOM.removeClass(d.document.getElementsByTagName("html")[0],g.CssClasses.activeBody),this.documentOverlay.dispose(),this.documentOverlay=null,this._isResettingPosition=!1,g.unsetActivateInstance(this),a.Events.fire(this,{type:g.EventTypes.onHide,
...
this.carousel.onTouch(b.action,b.point);break;case a.TouchElement.ActionTypes.touchStart:case a.TouchElement.ActionTypes.touchMoveEnd:this.carousel.onTouch(b.action,b.point);break;case a.TouchElement.ActionTypes.tap:this.toggleToolbar();break;case a.TouchElement.ActionTypes.doubleTap:this.settings.target===d&&(b.point.x-=a.DOM.windowScrollLeft(),b.point.y-=a.DOM.windowScrollTop());var c=this.cache.images[this.currentIndex].imageEl,e=d.parseInt(a.DOM.getStyle(c,"top"),10),f=d.parseInt(a.DOM.getStyle(c,
"left"),10),h=f+a.DOM.width(c),c=e+a.DOM.height(c);b.point.x<f?b.point.x=f:b.point.x>h&&(b.point.x=h);b.point.y<e?b.point.y=e:b.point.y>c&&(b.point.y=c);this.createZoomPanRotate();this.isZoomActive()&&this.zoomPanRotate.zoomAndPanToPoint(this.settings.doubleTapZoomLevel,b.point);break;case a.TouchElement.ActionTypes.gestureStart:this.createZoomPanRotate()}a.Events.fire(this,{type:g.EventTypes.onTouch,target:this,point:b.point,action:b.action})},onCarouselSlideByEnd:function(b){this.currentIndex=b.cacheIndex;
a.isNothing(this.toolbar)||(this.toolbar.setCaption(this.currentIndex),this.toolbar.setToolbarStatus(this.currentIndex));a.Events.fire(this,{type:g.EventTypes.onDisplayImage,target:this,action:b.action,index:b.cacheIndex})},onToolbarTap:function(b){switch(b.action){case e.ToolbarAction.next:this.next();break;case e.ToolbarAction.previous:this.previous();break;case e.ToolbarAction.close:this.hide();break;case e.ToolbarAction.play:this.play()}a.Events.fire(this,{type:g.EventTypes.onToolbarTap,target:this,
toolbarAction:b.action,tapTarget:b.tapTarget})},onMouseWheel:function(b){var c=a.Events.getWheelDelta(b);b.timeStamp-(this.mouseWheelStartTime||0)<this.settings.mouseWheelSpeed||(this.mouseWheelStartTime=b.timeStamp,this.settings.invertMouseWheel&&(c*=-1),0>c?this.next():0<c&&this.previous())},onCarouselSlideshowStart:function(){a.Events.fire(this,{type:g.EventTypes.onSlideshowStart,target:this})},onCarouselSlideshowStop:function(){a.Events.fire(this,{type:g.EventTypes.onSlideshowStop,target:this})},
onToolbarBeforeShow:function(){a.Events.fire(this,{type:g.EventTypes.onBeforeCaptionAndToolbarShow,target:this})},onToolbarShow:function(){a.Events.fire(this,{type:g.EventTypes.onCaptionAndToolbarShow,target:this})},onToolbarBeforeHide:function(){a.Events.fire(this,{type:g.EventTypes.onBeforeCaptionAndToolbarHide,target:this})},onToolbarHide:function(){a.Events.fire(this,{type:g.EventTypes.onCaptionAndToolbarHide,target:this})},onZoomPanRotateTransform:function(b){a.Events.fire(this,{target:this,
